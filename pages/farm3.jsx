    ...
    <>
      ...
      <section className="row h-100">
        <ScrollableSectionContainer className="col-8 d-flex">
          <div className="bg-am-gray-200 p-3 rounded-4 d-flex flex-column gap-2">
        ...
        <ScrollableSectionContainer className="col-4">
          <div className="rounded-4 p-3 my-2 bg-am-gray-200 width-100 d-flex flex-column text-white">
            <p>
