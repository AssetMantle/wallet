...
const MntlToGravityBridge = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    e.preventDefault();
    // execute dispatch function pertaining to submit
    formDispatch({
      type: "SUBMIT",
    });
    ...
    console.log({ localTransferAmount, memo, gravityAddress });
  ...
  const displayTransferableBalance =
    fromChainDenom(availableBalance).toString();
    ...
    >
      ...
      >
        ...
        <small className="small text-gray">
          Transferable Balance : {displayTransferableBalance}
          &nbsp;
          {defaultChainSymbol}
        </small>
      </label>
